"""CatBoost solo with recall-first top-K — seed 123 variant for vote pool diversity."""
...
def main() -> None:
    ...
    final = CatBoostClassifier(
        iterations=800, depth=5, learning_rate=0.03, subsample=0.8,
    ...
    meta = {"method": "catboost-recall-seed123", "k": k, "random_state": RANDOM_STATE, "threshold_strategy": thresh.strategy, "threshold": thresh.threshold}
    joblib.dump(meta, artifacts_dir / "meta.joblib")
    write_artifacts_manifest(artifacts_dir)

    metrics = {
        "method": "catboost-recall-seed123",
        "k": k,
    ...
    plot_pr_curve(y, oof_proba, plots_dir / "oof_pr_curve.png", "CatBoost seed123 OOF PR")
